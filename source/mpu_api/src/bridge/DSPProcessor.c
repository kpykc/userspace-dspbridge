 ...
 *! 12-Dec-2000 rr: DSP_ProcessorEnumNodes returns -EINVAL if
 ...
 *! 12-May-2000 gp: Removed PROC_UNKNOWN state.  Mapped to return -EPERM.
 *!                 Return -EFAULT in DSPProcessor_Ctrl()/Detach().
 *!                 Return -EBADR from DSPProcessor_Start().
