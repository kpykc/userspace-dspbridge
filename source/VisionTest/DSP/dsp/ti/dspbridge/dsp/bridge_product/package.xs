...
function getLibs()
{
	...
	var base = "bios" + (prog.build.debug == true ? "i" : "");

	/* return the library name: dir/dir.a<arch> */
	var lib = "legacy/lib/" + base + ".a" + prog.build.target.suffix;
...
function getSects()
{
    return ("ti/dspbridge/dsp/bridge_product/bridge_product.xdt");
}
