...
# Start Vision framework
	...
	ftp.storbinary("STOR dsp/cexec.out", file("target/dspbridge/cexec.out", "rb"))
	ftp.storbinary("STOR dsp/dynreg.out", file("target/dspbridge/dynreg.out", "rb"))
	ftp.storbinary("STOR dsp/ping.out", file("target/dspbridge/ping.out", "rb"))
	ftp.storbinary("STOR dsp/dmmcopy.out", file("target/dspbridge/dmmcopy.out", "rb"))
	ftp.storbinary("STOR dsp/dmmcopydyn_3430.dll64P", file("target/dspbridge/dmmcopydyn_3430.dll64P", "rb"))
	#ftp.storbinary("STOR dsp/baseimage.dof", file("../../tiBinaries/baseimage.dof", "rb"))
	#ftp.storbinary("STOR dsp/ddspbase_tiomap3430.dof64P", file("target/dspbridge/ddspbase_tiomap3430.dof64P", "rb"))
	ftp.storbinary("STOR dsp/libbridge.so.2", file("target/lib/libbridge.so.2", "rb"))
	execute_command("cd /data/video/dsp")
	execute_command("chmod +x cexec.out")
	execute_command("chmod +x dynreg.out")
	execute_command("chmod +x ping.out")
	execute_command("chmod +x dmmcopy.out")
	execute_command("chmod +x libbridge.so.2")
	execute_command("cp libbridge.so.2 /lib/")
	print("Done")
