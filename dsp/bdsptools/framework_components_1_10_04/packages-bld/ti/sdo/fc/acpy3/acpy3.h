...
typedef struct ACPY3_Params {
     ...
     *  (SCIDX): signed value between -32768 and32767.
     */
    MdInt srcFrameIndex;
...
#else
Void ACPY3_setFinal(IDMA3_Handle handle, MdInt transferNo);
#endif
...
#else
Void ACPY3_fastSetFinal(IDMA3_Handle handle, MdInt transferNo);
#endif
